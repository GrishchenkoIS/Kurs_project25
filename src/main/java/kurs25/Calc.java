...
@WebServlet(name="Calc", urlPatterns="/JavaCalc") //Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦ Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦Ð Ñ—Ð¡â€”Ð â€¦ Ð Ñ—Ð¡â€”Ð â€¦ URL
	...
	public static class RequestCalc {
		...
		public void setAsRequestAttributesAndCalculate(HttpServletRequest request) {
			...
			if (target.equals("ready house")) {
				request.setAttribute("target_result", "Ãîòîâîå æèëüå");
			} else if (target.equals("new house")) {
				request.setAttribute("target_result", "Íîâîñòðîéêà");
			} else {
				request.setAttribute("target_result", "Êîììåð÷åñêîå");
			}
			if (strahovka.equals("No")) {
				request.setAttribute("strahovka_result", "Íåò");
			} else {
				request.setAttribute("strahovka_result", "Åñòü");
			}
			if (currency.equals("dollar")) {
				request.setAttribute("currency_result", "Äîëëàð");
				request.setAttribute("currency_for_result", "Äîëëàðîâ åæåìåñÿ÷íî");
			} else if (currency.equals("rub")) {
				request.setAttribute("currency_result", "Ðóáëü");
				request.setAttribute("currency_for_result", "Ðóáëåé åæåìåñÿ÷íî");
			} else {
				request.setAttribute("currency_result", "Åâðî");
				request.setAttribute("currency_for_result", "Åâðî åæåìåñÿ÷íî");
			}
