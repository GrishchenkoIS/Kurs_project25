...
public class CalculationRH extends Calculator {
	double res;
	public CalculationRH() {
	...
	public Double Calculator() {
		...
		if (IsDouble(Calc.RequestCalc.stavka.get(0))) {
			rate = Double.parseDouble(Calc.RequestCalc.stavka.get(0));
		} else {
			rate = 8.3;
		}
